/**
 * Synthetic drawings for the Comparator reliability gate.
 *
 * Every file is generated here; no customer or real-project document is used,
 * and nothing written by this script is committed (`test-fixtures/` is
 * ignored).
 *
...
const OUT = path.join(ROOT, 'test-fixtures', 'comparator');
...
console.log(`\n  wrote ${written.length} fixtures to test-fixtures/comparator/\n`);
