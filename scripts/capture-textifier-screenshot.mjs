...
// A crooked, speckled sheet: the fixture the preprocessing controls are for.
const FIXTURE = 'scanned-skew-noisy.pdf';
...
try {
    ...
    await page.waitForFunction(() =>
        [...document.querySelectorAll('input[type="checkbox"]')].filter((c) => c.checked).length === 2);
